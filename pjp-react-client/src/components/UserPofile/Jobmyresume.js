									...
									<div className="candidate-detail">
										...
										<div className="text-white browse-job text-left">
											...
											<ul className="clearfix">
												<li><i className="ti-location-pin"></i> Salfit, Palestine</li>
												<li><i className="ti-mobile"></i> +9702 5453052</li>
												<li><i className="ti-briefcase"></i> Fresher</li>
												<li><i className="ti-email"></i> mlkibrahem6@gmail.com</li>
											</ul>
								...
								<div className="row">
									...
									<div className="col-xl-9 col-lg-8 col-md-8 col-sm-12">
										<div id="resume_headline_bx" className=" job-bx bg-white m-b30">
											...
											<p className="m-b0">Job board currently living in Palestine</p>
											...
											<div className="row">
												<div className="col-lg-6 col-md-6 col-sm-6">
													<div className="clearfix m-b20">
														...
														<span className="clearfix font-13">14 May 1998</span>
													</div>
													<div className="clearfix m-b20">
													...
													<div className="clearfix m-b20">
														...
														<span className="clearfix font-13">+ 970 5453052</span>
													</div>
													<div className="clearfix m-b20">
												...
												<div className="col-lg-6 col-md-6 col-sm-6">
													...
													<div className="clearfix m-b20">
														...
														<span className="clearfix font-13">Palestine</span>
													</div>
												</div>
											</div>
